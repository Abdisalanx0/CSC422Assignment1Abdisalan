...
public class PetDatabase {
    ...
    public static String filename = "pets3.txt";
    ...
    while (true) {
        ...
        try {
            ...
            if (age < 1 || age > 20) {
                System.out.println("Invalid age. Age should be between 1 and 20.");
                continue; // Ask for input again if age is out of range
            }
